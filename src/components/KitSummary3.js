...
function KitSummary3() {
  ...
  const [currentImg, setCurrentImg] = useState(Kits[2].image)
    ...
    <>
      <div className="summary-container">
        ...
        <div className="bottom-row">
          {<img onClick={(e) => setCurrentImg(e.target.src)} className='tiny' src={Kits[2].image} alt='building'/>}
         {<img onClick={(e) => setCurrentImg(e.target.src)} className='tiny' src={Kits[2].Blueprint} alt='building'/>}
          </div>

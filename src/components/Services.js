    ...
    <>
      <div className="services-container">
        <div className="first-service">
          <img className="services-images" src={`${process.env.PUBLIC_URL}/images/new-construction.jpg`} alt='construction building'/>
        ...
        <div className="second-service">
          <img className="services-images" src={`${process.env.PUBLIC_URL}/images/eckhart.jpg`} alt='building'/>
        ...
        <div className="third-service">
          <img className="thirdServices-images" src={`${process.env.PUBLIC_URL}/images/permit.jpg`} alt='permit'/>

    ...
    <>
      <div className="about-top">
        <div className="mt-image">
          <img className="mt-hood" src="/images/mt-hood.jpg" alt="mt hood" />
        </div>
      </div>
      ...
      <div className="about-bottom">
        ...
        <div className="bottom-column">
          ...
          <p className="about-p">
            ...
            specialize in building Shops, Garages, RV Storage, Agricultural
            Barns, Stall Barns, Arenas, Storage Buildings, Warehouses, Accessory
        ...
        <div className="bottom-column">
          ...
          <p className="about-p">
            Most importantly to serve with character and purpose that brings
            honor to God.
          </p>
          <p className="about-p">
            ...
            maintain the highest levels of professionalism, integrity, honesty
            and fairness in our relationships with our suppliers,
            subcontractors, professional associates and customers. To provide
            our employees with an honest and helpful working environment, where
            every employee individually and collectively, can dedicate
            themselves to providing our customers with exceptional workmanship,

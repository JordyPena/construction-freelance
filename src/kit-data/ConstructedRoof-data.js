...
const data = [
  {
    ...
    Title: `24' x 36' x 12' Roof Only`,
    KitPrice: `$13,500.00`,
    Description: `Engineered Building`,
    Materials: [
      { material1: "Painted Steel" },
      { material2: `12" Overhang` },
      { material3: "Trusses" },
      { material4: "Premium Trim Package" },
    ],
    labors: [
    ...
    Features: [{ feature1: `2" Blanket Insulation in roof: +$464.00` }],
...

  {
    ...
    Features: [{ feature1: `2" Blanket Insulation in roof: +$630.00` }],
    Disclosure: `Price is for a building constructed within 50 miles of our location and no backfill, concrete slab, permit, or excavation is included in the price. Customer is to provide a level hazard free site.`,
    id: 8,
  },
  ...
  {
    image: ThirtySixRoof,
    Title: `36' x 48' x 16' Roof Only`,
    KitPrice: `$20,100.00`,
    Description: `Engineered Building`,
    Materials: [
      { material1: "Painted Steel" },
      { material2: `18" Overhang` },
      { material3: "Trusses" },
      { material4: "Premium Trim Package" },
    ],
    labors: [
    ...
    Features: [{ feature1: `2" Blanket Insulation in roof: +$900.00` }],
    Disclosure: `Price is for a building constructed within 50 miles of our location and no backfill, concrete slab, permit, or excavation is included in the price. Customer is to provide a level hazard free site.`,
    id: 9,
  },

  {
    ...
    Features: [{ feature1: `2" Blanket Insulation in roof: +$1,216.00` }],
    Disclosure: `Price is for a building constructed within 50 miles of our location and no backfill, concrete slab, permit, or excavation is included in the price. Customer is to provide a level hazard free site.`,
    id: 10,
  },

  {
    ...
    Features: [{ feature1: `2" Blanket Insulation in roof: +$1,900.00` }],
    Disclosure: `Price is for a building constructed within 50 miles of our location and no backfill, concrete slab, permit, or excavation is included in the price. Customer is to provide a level hazard free site.`,
    id: 11,
  },
